...
let selectedWord = wordBank.randomElement()
var wordToGuess = ""
var chancesLeft = 5
...
//for (index, value) in selectedWord!.enumerated() {
//    if value == (userInput()) {
//        wordToGuess[index] = (readLine())
//    }
//}

func checkForWord(letter: String) -> Bool {
return false
}
...
while chancesLeft >= 0 {
print(readLine())
checkForWord(letter: readLine()!)
print(chancesLeft)
if chancesLeft == 0 {
print("Game Over, You Lose \u{2639}")
//    } else {
//      if chancesLeft != 0 {
...
func numberOfGuessesLeftandUpdateOfWord(character: String) {
...
var wordToGuess = ""
let guesses = Int
let currentWordT = currentWord.stringByReplacingOccurrencesOfString(" ", withString:"")
let numberOfLetters = theAnswer.characters.count as Int
...
func UserWon() -> Bool {
for ch in selectedWord!.characters {
if "\(ch)" == "_" {
return false
print ("You Win \u{263A}")
} else {
